// lib/queries.js  — replaces lib/models.js entirely
import pool from './db';

// ═══════════════════════════════════════════════════════
// STUDENTS  (was UserModel)
// ═══════════════════════════════════════════════════════
...
export async function deleteUserByEmail(email) {
  await pool.query(
    `DELETE FROM students WHERE LOWER(email) = LOWER($1)`,
    [email.trim()]
  );
}

// ═══════════════════════════════════════════════════════
// RESULTS  (was ResultModel)
// ═══════════════════════════════════════════════════════
...
// ═══════════════════════════════════════════════════════
// LEADERBOARD  (was LeaderboardModel)
// ═══════════════════════════════════════════════════════
